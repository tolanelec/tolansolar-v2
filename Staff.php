<?php if(preg_match("/MSIE/",getenv("HTTP_USER_AGENT")) || preg_match("/Internet Explorer/",getenv("HTTP_USER_AGENT"))){header('Location:http://localhost/xampp/tolansolar-v1/Staff.php'); }?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transistional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
<head>

 <title>Tolan Staff - Staffing</title>	
<meta name="description" content=" Tolan-solar , sells solar lighting products ">
<meta name="keywords" content="Tolan-solar", "company", "business culture", "staff">
	...
	<div id="sidebar">
	    <div id="column1">
		  ...
		  <span id="contents2">
			...
			<span id="contents3">
			<h3 class="blue">Vacancy and Job opportunities</h3>
