...
<meta name="description" content=" Tolan-solar , sells solar lighting products ">
<meta name="keywords" content="Tolan-solar solar solutions","solar lamps", "Solar lights", "Rechargable lanterns"  >
...
<script  id='googlecart-script' type='text/javascript' src='https://checkout.google.com/seller/gsc/v2_2/cart.js?mid=146701109927099' integration='jscart-wizard' post-cart-to-sandbox='false' currency='GBP' productWeightUnits='KG'></script>
	...
	<div id="sidebar">
		...
		<div id="column_small">	
			...
			Price range from <strong>£3.00</strong></p><span style="float:right"><div class="product"><input type="hidden" class="product-title" value="LED-AAlamps"><input type="hidden" class="product-price" value="N3.00">
			...
			Price range from <strong>£5.00</strong> </p><span style="float:right"><div class="product"><input type="hidden" class="product-title" value="rechargable Lanterns"><input type="hidden" class="product-price" value="N5.00">
			...
			For lighting special events, filming, security. Price range from <strong>£15.00</strong></p><span style="float:right"><div class="product"><input type="hidden" class="product-title" value="security lamps"><input type="hidden" class="product-price" value="15.00">
			<div class="googlecart-add-button" tabindex="0" role="button" title="Add to cart"></div></div></span></p></span>
			...
			<div id="googlecart-widget-control" googlecart-widget-control-align="center" style="border:1px; margin-top:-180px; margin-left:-30px; margin-right:-30px; z-index:8; width:80px; height:40px;"><img src="images/shopping_cart_icon6.gif" />
				<b>Item List : </b><span id="googlecart-item-count" style="float:right"></span>
