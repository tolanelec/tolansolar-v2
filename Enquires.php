...
.scrolldown { padding-left:20px; color:#EDECE8; font-size:14px; font-weight:bold; vertical-align:middle;
 ...
 .results { border: 1px solid blue; padding:15px; margin-top:15px; min-height:30px; }
...
#register-form {
    ...
    margin-left: 10px;
    margin-top:0px;
    width: 420px; padding-left:15px; padding-right:15px; padding-top:15px; padding-bottom:15px
	z-index:1;
}
...
#register-form .fieldgroup {
    ...
    display: inline-block;
    width: 380px; padding-left:10px; padding-right:15px; padding-top:5px; padding-bottom:5px
}
            ...
            $("#register-form").validate({
				rules: {
				 ...
				 messages: {
				   ...
				   inquiry:"please select topic",
				   content: {
					  required:"Please provide query",
					  minlength:"Please complete inquiry"
				   },
				   contact: {
				      required:"please provide a number",
					  minlength: "your phone must be atleast 9 characters long" },
	...
	<span id= "contents2">
			...
			<div id="form-content">
				<fieldset>
						...
						<div class="fieldgroup">
						<label for="content">Customer Query</label>
						<textarea style="height:60px; width:280px;" maxlength="500" name="content" placeholder="Please enter comment and a reference number if available " ></textarea>
						</div>
						<br>
						
						<div class="fieldgroup">
						<label for="inquiry">select concern </label>
						<select name="inquiry" size="30"/>
						...
						<div class="fieldgroup">
						<p class="right">By clicking Send button you accept our <a target="_blank" href="Policy.php">policy</a>.</p>
